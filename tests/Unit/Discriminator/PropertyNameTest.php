...
class PropertyNameTest extends TestCase
{
     ...
     * hold the discriminating value. This property **SHOULD** be
    ...
    #[Test] public function propertyName(): void
    {
        ...
        self::assertEquals(
            ...
            message: 'REQUIRED. The name of the property in the payload that will hold the discriminating value. This property SHOULD be required in the payload schema, as the behavior when the property is absent is undefined.'
        );
    }
}